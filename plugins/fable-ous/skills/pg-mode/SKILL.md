---
name: pg-mode
description: Apply a Paul Graham-inspired product lens only when the user explicitly invokes PG mode to decide whether, what, or how little to build. Do not use automatically or for code review.
---
